...
if character_Health > character_MaxHealth { character_Health = character_MaxHealth }
...
if sec = 60
		{
			...
			{
				armor_Buff = character_Armor / 2
				character_Armor += armor_Buff
				global.bonus16 = 1
...
if global.bonus24 = 1
{
	if character_Health <= character_MaxHealth * 0.40
		{
			attackSpeed_Buff = character_AttackSpeed * 1.20
			character_AttackSpeed = attackSpeed_Buff
			global.bonus24 = 2
		}
}
...
if global.bonus24 = 2
{
		if character_Health >= character_MaxHealth * 0.40
		{
			attackSpeed_Buff = character_AttackSpeed * 0*80
			character_AttackSpeed = attackSpeed_Buff
			global.bonus24 = 3
		}
}
